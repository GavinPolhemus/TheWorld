...
\registerunit[unit]
 [unitless=unitless,
  J=joule,
  N=newton, %N is messing up nano, causing N•s.
  cyc=cycle,
  cycle=cycle,
  rad=radian,
  h=hour,
  ...
  V=volt,
  T=tesla,
%  C=coulomb,% C is messing up centi, causing cm -> C•m.
%  K=K,% K is messing up kilo, causing kg -> K•g.
  Ω=ohm]
\setupunittext
 [unitless=\strut,
  cycle=cyc,
...
\definemathfence[vabs][doublebar][command=yes]
\definemathfence[components][angle][command=yes]
\definemathfence[coordinates][parenthesis][command=yes]
