...
The next rule gives the derivative of functions that are powers of $t$, like $t^2$, $t^{-1}$, or $t^1 = t$. The derivatives of these powers is given by the \keyterm{power rule}. 
\startformula
	\ddt t^n = nt^{n-1}
\stopformula
