...
% Fonts
%
% The method sent by Minion Math
% \definefontfamily [mainfont] [rm][Libertinus Serif]% Libertinus for Text %[Minion Pro] % Minion Pro for Text
% \definefontfamily [mainfont] [math][Libertinus Math]% Libertinus for Math % [Minion Math] % Minion Math for Math
% \definefallbackfamily[mainfont][math][Cambria Math] % Script missing in MinionMath
%                      [range={uppercasescript, lowercasescript}]
% \definefallbackfamily[mainfont][math][Latin Modern Math] % Fraktur missing in MinionMath
%                      [range={uppercasefraktur, lowercasefraktur}]
\setupbodyfont [libertinus,11pt]% [mainfont,11pt] % Also possible, and free
% Methods using typecripts from ConTeXt
...
\usemodule[lettrine] % HR: is this necessary? probably outdated (LMTX?)
...
\setupheadertexts[margin][][\hfill\pagenumber][\pagenumber \hfill][] % HR: does \hfill work here at all?

% Indenting
\setupindenting[yes,medium] % HR: not "next"?

% Emphasis
% HR: setup changed, use highlights, not just defines
...
% HR: do you need to be LaTeX compatible?
\define[1]\ref{\in[#1]}
...
\setupnote[endnote][
	...
	%symbolcommand={\#1.}, % HR: does this work at all?
...
% Text Fractions
% HR: this might be easier with OpenType features
...
%% Fractions in Minion
%\define\half{{\textstyle\frac{1}{2}}}
%% /denominator
%\define\halves{\textfraction\getnamedglyphdirect{minion}{two.denominator}} % /2
%\define\quarters{\textfraction\getnamedglyphdirect{minion}{four.denominator}} % /4
%% numerator
%\define\fracthree{\getnamedglyphdirect{minion}{three.numerator}}
%\define\fracfive{\getnamedglyphdirect{minion}{five.numerator}}
%\define\fracnine{\getnamedglyphdirect{minion}{nine.numerator}}
%\define\fracsixteen{\getnamedglyphdirect{minion}{one.numerator}\getnamedglyphdirect{minion}{six.numerator}} % 16
%% numerator/denominator
%\define\fivequarter{\text{\fracfive\quarters}} % 5/4
%\define\sixteenquarter{\text{\fracsixteen\quarters}} % 16/4
%\define\ninequarter{\text{\fracnine\quarters}} % 9/4
%\define\threehalf{\text{\fracthree\halves}} %  3/2
