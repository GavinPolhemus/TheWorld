...
\stopformula
The \scaps{si} units for \m{v} on the left are \m{\unit{m/s}}. The units on the right should be converted to \m{\unit{m\.rad/s}} which turn into \m{\unit{m/s}} when the radians disappear.
