...
\startsolution
Use conservation of angular momentum to relate the changeing angular velocity to the changing distance. We will go from the closest point, where Earth's angular velocity is greatest, to the farthest point, where Earth's angular velocity is lowest.
