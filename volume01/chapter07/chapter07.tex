...
The four inner planets are shown at their correct distances from the Sun along the top of \in{figure}[fig:EnergyGraphKUH]. Take a moment to locate Venus and Earth, and compare the energy graphs for these two planets. Earth's is the same $U+K_\theta$ curve shown in \in{figure}[fig:EnergyGraphKU]. The $U+K_\theta$ curve for Venus is a similar shape, but shifted down toward lower energy and left toward smaller $r$. This shift is due to Venus's lower angular momentum . Lower angular momentum gives Venus a lower angular kinetic energy $K_\theta = L^2/2mr^2$, which is why Venus's $U+K_\theta$ curve in \in{figure}[fig:EnergyGraphKUH] is lower than Earth's.
...
Mercury has much less angular momentum, so its $U+K_\theta$ curve is even lower and farther left than Venus's, putting Mercury much closer to the Sun. Unlike Venus and Earth, Mercury's orbit is quite eccentric. Mercury does not sit right at the minimum of its $U+K_\theta$ curve. Mercury's total energy $H$, shown by the thick, short, horizontal line labeled \quotation{Mercury,} is somewhat higher than the minimum of the $U+K_\theta$ curve. This looks very much like the energy graph for a simple harmonic oscillator, and Mercury does indeed oscillate in the $r$ direction as it orbits the Sun. The endpoints of Mercury's total energy line are Mercury's turning points. The left end of the line represents Mercury's closest approach to the Sun, and the right end represents Mercury's greatest distance from the Sun. This range of distances is shown by the range of positions for Mercury at the top of \in{figure}[fig:EnergyGraphKUH].
...
Like Mercury, Mars has an eccentric orbit and does not sit at the minimum of the $U+K_\theta$ curve. The thick, horizontal line labeled \quotation{Mars} shows Mars's total energy $H$ as it oscillates between the two turning points on the the $U+K_\theta$ curve. The minimum of Mars's $U+K_\theta$ curve is much wider and shallower than the minimum of Mercury's curve, so Mars oscillates much more slowly that Mercury. Mars's oscillations have a period of 687 days.
...
\marginTikZ{\vskip4.2in}{UKMars3D}{A planet with angular momentum will not crash into the Sun, it will orbit.} % vskip, name, caption
