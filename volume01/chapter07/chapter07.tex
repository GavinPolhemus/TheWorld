...
The six planets known to Kepler are show at the correct distances along the $r$-axis on the energy graph. Notice how these distances approximately match the distances in Kepler's model. The  four inner planets – Mercury, Venus, Earth, and Mars – are quite close together. Jupiter and Saturn are much further out.
...
A planet following a circular orbit with the Sun at the center moves with uniform circular motion.
...
The planet's distance determines its angular velocity, with much higher angular velocities closer to the Sun. Higher angular velocities give shorter periods.
\startformula
	T = \frac{2\pi}{\omega}
\stopformula
...
Kepler's own calculations showed that his model was not as accurate as he had originally hoped. However, he correctly recognized the Sun's important role as the center and the physical driver of the solar system.
