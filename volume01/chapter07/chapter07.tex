...
\startformula
	F %= -\pp{r} U
		...
		= -G\frac{mM}{r^2}
\stopformula
The \emph{magnitude} of this gravitational force is the centripetal force above, allowing us to fined the planet's angular velocity.
...
\stopformula
Mercury's orbit takes only 88 days. Venus orbits in 225 days. Earth's orbit is 365 days. Mars' orbit is 687 days. The outer planets' orbits are far longer – nearly twelve years for Jupiter's orbit and almost thirty years for Saturn.
