...
Kepler then worked diligently for eight months. Tycho died in 1601, and Kepler succeeded him as Imperial Mathematicus, still without a solution for Mars's orbit.
...
The areas swept out by Mars are not the same as the areas swept out by Mercury. Both planets have constant specific angular momentum, but Mars's specific angular momentum is much greater than Mercury's.
Mars's specific angular momentum is about twice Mercury's, so Mars sweeps out about twice the area that Mercury does in the same time. You can roughly check this by measuring the areas in \in{figure}[fig:KeplerTerestrial].
...
Like Earth, Venus sits right near the minimum of its $\Phi+k_\theta$ graph, always staying nearly the same distance from the Sun in a nearly circular, centered orbit. The dotted line in \in{figure}[fig:EnergyGraphKUH] shows the radius and specific energy of every possible circular, centered orbit. (See \in{figure}[fig:CircularH], \at{p.}[fig:CircularH].) This dotted line passes right through the minimum of every $\Phi+k_\theta$ curve. Earth and Venus sit on this line, since they are both in nearly circular, centered orbits.
