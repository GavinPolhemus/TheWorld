...
Daniel Bernoulli’s method – linking kinetic energy, work, and potential energy – has continued to provide insight into every know physical process, from particle interactions to the expansion of the universe. In the centuries since the publication of \booktitle{Hyrodynamica} much of the important progress in physics has come from properly identifying and quantifying the many forms of energy.
