...
\startexample[]
	...
	\stopmathalignment\stopformula
	Initially only one cart is moving. I have called that cart \m{A}, with initial momentum \m{p\sub{$A$i}}. The other cart, cart \m{B}, is not moving initially so its initial momentum is zero. The final momentum is the total final momentum of both carts together.
