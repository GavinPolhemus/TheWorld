...
A rift developed between Leibniz’s supporters, who used $mv^2$, and Newton’s supporters, who used $mv$. Newton’s supporters were called the Cartesians, because Descartes' formula was also $mv$. Fittingly, the Cartesians sometimes included direction, as Newton taught them, and sometimes they did not, reverting to Descartes’ directionless quantity of motion. It was a mess.
...
In a collision, momentum changes suddenly when the objects make contact.
A planet’s momentum changes gradually due to the constant gravitational force of the Sun.
...
The moons of Jupiter are held in orbit by Jupiter’s gravitational force, while our moon is held in orbit by Earth’s gravitational force. Earth’s gravitational force is ever present not only for the moon, but for everything near Earth, including each of us. We will start our study of gravity here, on Earth’s surface. Once we master the tremendous power of vectors, we too will turn our attention to the heavens.
...
Acceleration complicates our efforts to predict an object’s future position. The position update formula for constant velocity, $x\si + v\Delta t = x\sf$, only works if the velocity remains constant throughout the duration $\Delta t$. However, we can still succeed by focusing on a short duration $dt$ during which the velocity changes very little. During this short duration, the position changes by small amount $dx$, given by the position update formula for accelerated motion.
\startformula
dx = v\,dt
\stopformula
If we know the velocity at each time, even if the velocity is changing, we can break the time into many brief steps. We then proceed through these steps, updating the position each step by adding the small changes calculated above. With small steps, this process can be quite accurate – and quite tedious!
