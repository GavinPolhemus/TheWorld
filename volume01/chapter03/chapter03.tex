...
\Initial{I}{n 1629, René Descartes} wrote to Marin Mersenne with an ambitious plan.
\startblockquote
I have resolved to explain all of the phenomena of the natural world, that is to say, all of physics.\autocite{p.~viii.}{Descartes1633}
\stopblockquote
He proceeded to write a charming book called \booktitle{The World, or a Treatise on Light}, in which he seeks to explain everything from the smallest parts of matter to the distant stars.
His explanation depends on your participation, because you must see the world as he explains it.
The only way to see all the world's fine details and vast distances is in your imagination.
%Recognizing the book's daunting scope, Descartes offers a plan to make \booktitle{The World} engaging.
%\startblockquote
%In order, however, to make the length of this discourse less boring for you, I want to wrap part of it in a fable.\autocite{p.~49.}{Descartes1633}
%\stopblockquote
%The fable is a shared journey of imagination, which we will join.
%For Descartes to explain this world, you must see it in your imagination.
\startblockquote
For a short time, then, allow your thoughts to wander beyond this world to view another, wholly new one, which I shall cause to unfold before it in imaginary spaces.\autocite{p.~49.}{Descartes1633}
\stopblockquote
Accepting Descartes' invitation, unfold your imaginary world far from Earth and the Solar System, so that everything in the new world is according to your own imagination.

Populate your imaginary space with a multitude of tiny parts of matter. These parts have few properties of their own. They are not made of particular substances, \quotation{such as of wood, or stone, or metal}, but are of pure matter, which does not have \quotation{qualities of being hot or cold, dry or moist, light or heavy, or of having some taste, or smell, or sound, or color.} Descartes wishes to keep the matter simple so that you are confident in understanding every detail of your newly imagined world.

This simple matter does not compress or expand, and no part of it may occupy the same space as another.
\startblockquote
Let us add further that this matter can be divided into any parts and according to any shapes that we can imagine, and that each of its parts is capable of receiving in itself any motion that we can also conceive.\autocite{p.~53.}{Descartes1633}
\stopblockquote

Made of this simple matter, our tiny imagined parts are \quotation{some larger and some smaller, some of one shape and some of another, as it pleases us to imagine them.}\autocite{p.~53.}{Descartes1633}
Imagine each of these parts has been created in a state of motion, so that \quotation{some begin to move in one direction and others in another, some faster and others slower (or indeed, if you wish, not at all)\dots.} You may make \quotation{the most confused and most disordered chaos that the poets could describe\dots.} Even in this chaos, you comprehend every detail.
\startblockquote
For, as regards the qualities that I have posited there, I have, if you have noticed, supposed them to be only such as you can imagine. And, as regards the matter from which I have composed the chaos, there is nothing simpler nor easier to know\dots.
\stopblockquote

Descartes has given you complete freedom to imagine the parts in any shapes and sizes and in any initial  state of motion that you desire. But once set in motion, the parts must strictly obey specific rules, which he calls \quotation{natural laws.}
Descartes' first rule is a concise restatement of Galileo’s observation that motion naturally continues.
\startblockquote
	The first [rule] is that each individual part of matter always continues to remain in the same state unless collision with others constrains it to change that state. That is to say, if the part\dots%has some size, it will never become smaller unless others divide it; if it is round or square, it will never change that shape without others forcing it to do so; if it
...
\stopblockquote
As you view the chaos of tiny moving parts, imagine them following this rule\dash each moving part continuing to move until it strikes another part, and any resting part remaining at rest until another part strikes it.

Descartes then offers a second, entirely new rule, which has become one of the most important ideas in physics.
\startblockquote
...
\stopblockquote
In other words, motion is not created or destroyed, but passed from one part to another whenever two parts collide. If one part's motion is reduced by the collision, the other part's motion is increased by the same amount. Therefore, the two parts' \emph{total} motion does not change.


Apply this rule to the many collisions occuring in your imagined world.
You will find that the world's motion never ceases\dash or even decreases by the slightest amount\dash because each part's motion is constant from one collision to the next, and each collision redistributes  motion without reducing it.
Having \quotation{placed a certain quantity of motion in all matter\dots at the first instant,} the world \quotation{conserves the same amount of it.}\autocite{p.~69. For Descartes, conservation of motion is a necessary consequence of \quotation{the very firmness and immutability that is in God.} He explains, \quotation{For, supposing that He placed a certain quantity of motion in all matter in general at the first instant He created it, one must avow that He always conserves the same amount of it there or not believe that He always acts in the same way.} Theology and physics are intertwined throughout Descartes' philosophy.}{Descartes1633}

Descartes' second rule is a \keyterm{conservation law}, which states that a certain quantity (in this case motion) remains constant in every interaction and therefore is a constant quantity for the universe. Conservation laws have proven to be among the most powerful ideas in physics, making our imagined world into a faithful model of the real world. Guiding you to a faithful model is the whole purpose of Descartes' \booktitle{The World}\dash and this is my purpose as well!

Starting from this simple model of colliding parts, Descartes explains the nature of light, heat and fire; liquids and solids; the formation of stars; and the orbits of planets and moons. He argues that this model gives rise to a heliocentric solar system like our real solar system.

Descartes' arguments in \booktitle{The World} lack many details, which he intended to provide in future work. However, his goal\dash explaining \quotation{all of physics}\dash would prove far more difficult than he imagined, and many of arguments in \booktitle{The World} would be proven wrong. Even so, \booktitle{The World} was an important step toward building a faithful model the real world.

Descartes completed \booktitle{The World} in 1633, but he did not publish it. He was concerned by the trouble Galileo faced after publishing \booktitle{Two World Systems} a year earlier.
Descartes' natural laws did appear later, in his 1644 textbook \booktitle{Principles of Philosophy}.
Descartes wrote this philosophy textbook to replace the current Aristotelian philosophy curriculum in France. The textbook's philosophy was adapted from Descartes' two earlier philosophical treatises, \booktitle{Discourse on Method}  and \booktitle{Meditations on First Philosophy}. The textbook's physics was based on Descartes unpublished \booktitle{The World}.

In \booktitle{Principles of Philosophy}, Descartes takes another important step by defining a \keyterm{quantity of motion}. 
According to Descartes, a moving object’s quantity of motion is equal to the object’s mass times its speed.
...
%\stopblockquote
Since mass and speed are positive, Descartes’s quantity of motion is always positive for a moving object, regardless of the motion’s direction. The quantity of motion is zero only if the object is at rest. %The total quantity of motion for a collection of objects is positive if any of them are moving and zero only if all of them are at rest.
...
%Descartes reveals an interesting consequence of his two rules: 
%Motion is passed from part to part in their collisions; \quotation{nevertheless,} Descartes observes, the total motion in the universe \quotation{has a certain fixed quantity} that never changes. In other words, \quotation{motion is conserved.}\autocite{p.~53–4. Translation by Paige Moore}{Descartes1644}


%Conservation of the total motion in the universe had important theological implications for Descartes, but it is not something we can test with experiments. How could you ever measure the total motion in the entire universe?  Conservation laws are often stated for the entire universe, but conservation of motion in individual collisions is much more useful for physics.


The quantity of motion formula allowed Descartes to calculate speeds in simple collisions between two objects.
In this case, the amount that one object speeds up can be determined based on how much the other object slows down.
...
\section{Collision experiments}
Not everyone accepted Descartes’s defense of his failed predictions.
Christiaan Huygens, who was well versed in Cartesian philosophy, produced a different set of rules for explaining collisions. 
...
Huygens completed his study of collisions in 1656, but he did not publish his results.
(I am amazed that all of the great research on motion\dash by Galileo, Descartes, and now Huygens\dash went unpublished for decades. Huygens complete, brilliant study of collisions was finally published as \booktitle{The Motion of Colliding Bodies} in 1703, eight years after his death!)


Fortunately, in 1668, the recently established Royal Society in London put out a request for papers on the topic of collisions. Huygens and others submitted papers explaining the rules for collisions that each of them had discovered. Isaac Newton describes their success, accompanied by the diagram shown in \in{figure}[fig:PrincipiaPendula].
...
To reproduce Wren's demonstration, hang two balls from identical long strings so that they are barely touching, as shown in Newton’s illustration (\in{fig.}[fig:PrincipiaPendula]). Pull one of the balls to the side and release it (\in{fig.}[fig:PendulumCollisionWren]). The location where it is released determines the speed with which it strikes the other ball. Until the collision, the motion of the ball is simple harmonic, though only for one-quarter period.  The quarter period motion can be seen in \in{figure}[fig:PendulumCollisionWrenGraph]. The maximum speed formula for simple harmonic motion (\at{p.}[eq:vmaxT]) gives the speed of the incoming ball as it arrives at the collision.
...
\startexample[ex:PendulumCollisionWren1]
	You reproduce Wren’s demonstration using pendulums with periods of $3.14$ seconds. 
	(This requires long strings, so the balls' centers are $\unit{2.45m}$ below the strings' tops.)
	%The larger, left ball has a mass of 75 grams, while the smaller, right ball has a mass of 25 grams.
	You pull the larger ball back a distance of $15.0$ centimeters and release it to strike the smaller ball, as shown in figure~\ref{fig:PendulumCollisionWren}. What is the larger ball’s velocity as it arrives at the collision? 	\startsolution
To find the speed at the collision point, we use the maximum speed formula for simple harmonic motion. The amplitude is the ball’s initial distance from its equilibrium point, $A=15.0\units{cm}$. (Vector notation is not required for one dimensional problems. For these I will continue to use $\abs{v}$ for speed and $v$ for velocity.)
	\startformula
		\abs{v}\sub{max} = \frac{2\pi A}{T}
			= \frac{2\pi\cdot15.0\units{cm}}{3.14\units{s}}
			= 30.0\units{cm/s}
	\stopformula
...
This can be used to find the velocity of the large ball.
	\startformula
		\abs{v}\sub{max} = \frac{2\pi A}{T}
			= \frac{2\pi\cdot8.0\units{cm}}{3.14\units{s}}
			= 16.0\units{cm/s}
	\stopformula
The same procedure gives the velocity of the small ball, which swings from its equilibrium position at $x=25\units{cm}$ to a stop at $x=46\units{cm}$.
	\startformula
		\abs{v}\sub{max} = \frac{2\pi A}{T}
			= \frac{2\pi\,\Delta x}{T}
			= \frac{2\pi(46.0\units{cm}-25.0\units{cm})}{3.14\units{s}}
			= 42.0\units{cm/s}
	\stopformula
...
\noindent Since pendulums collide frequently in this chapter, we will save work later by incorporating $A=\Delta x$ into the speed formula. This gives a formula for pendulum collision velocities.
\startformula
...
The balls will each take the same amount of time\dash one-quarter period\dash to reach the central collision point, even if they are different masses and are pulled back different distances. To time the collision correctly, simply release the balls at the same time!
...
\startexample[ex:PendulumCollisionWren3]
	You continue your collision experiments with the balls reversed. This time you pull both balls to the side and release them. The small ball catches up with the large ball and bounces off of it, as shown in figure \ref{fig:PendulumCollision3}. Find all of the velocities.
\startsolution
Before the collision, the small ball moves from $x=5.0\units{cm}$ to $x=25.0\units{cm}$.
	\startformula
		v = \frac{2\pi\,\Delta x}{T}
			= \frac{2\pi(25.0\units{cm}-5.0\units{cm})}{3.14\units{s}}
			= 40.0\units{cm/s}
	\stopformula
The large ball moves from $x=26.0\units{cm}$ to $x=30.0\units{cm}$.
	\startformula
		v = \frac{2\pi\,\Delta x}{T}
			= \frac{2\pi(30.0\units{cm}-26.0\units{cm})}{3.14\units{s}}
			= 8.0\units{cm/s}
	\stopformula
After the collision, the small ball moves from $x=25.0\units{cm}$ to $x=21.0\units{cm}$.
	\startformula
		v = \frac{2\pi\,\Delta x}{T}
			= \frac{2\pi(21.0\units{cm}-25.0\units{cm})}{3.14\units{s}}
			= -8.0\units{cm/s}
	\stopformula
The large ball moves from $x=30.0\units{cm}$ to $x=42.0\units{cm}$.
	\startformula
		v = \frac{2\pi\,\Delta x}{T}
			= \frac{2\pi(42.0\units{cm}-30.0\units{cm})}{3.14\units{s}}
			= 24.0\units{cm/s}
	\stopformula
...
The successful rules of collision helped Newton formulate general laws of motion, which he presented in his most important work, \booktitle{Philosophi\ae\ Naturalis Principia Mathematica}, published in 1687.
In \booktitle{Principia}, Newton introduced a new quantity of motion equal to mass times velocity. Mass is always positive, but velocity can be positive or negative depending on the direction of motion.
...
Gottfried Leibniz also admired the contributions of Huygens, Wallis, and Wren, and he began developing his own system of mechanics at the same time as Newton. Unlike Newton, Leibniz adopted Huygens’s formula $mv^2$ as the important quantity. Leibniz called $mv^2$ the \textit{vis viva} or \quotation{living force} and made it the basis of his own theory of motion. The \textit{vis viva} is much closer in spirit to Descartes’s original quantity of motion because $mv^2$ is positive for any motion and zero only for systems completely at rest, just like Descartes’s $m\abs{v}$.
...
Newton begins the first chapter by defining the \quotation{quantity of matter,} which we call \keyterm{mass}. Compressing, stretching, or even melting an object does not change its mass, although it might change its volume. An object’s mass can only be changed by adding matter or taking matter away.
...
\stopblockquote
In other words, the total momentum of a collection of objects cannot be changed by forces exerted by those objects on each other.
...
\startbuffer[NewtonCollision]
	...
	\fill [on layer={axis background}] (-0.5,0) rectangle (49.5,-1.5)[opacity=.1];
	\node[right, align = left] at (-1,5) {$\Delta p_A = 9$\\$\Delta p_B = -9$};
	\coordinate (B) at (25,249);
	\coordinate (A) at (30,249);
	...
	\fill [on layer={axis background}] (-0.5,0) rectangle (49.5,-1.5)[opacity=.1];
	\node[right, align = left] at (-1,5) {$\Delta p_A = 10$\\$\Delta p_B = -10$};
	\coordinate (B) at (25,249);
	\coordinate (A) at (30,249);
	...
	\fill [on layer={axis background}] (-0.5,0) rectangle (49.5,-1.5)[opacity=.1];
	\node[right, align = left] at (-1,5) {$\Delta p_A = 11$\\$\Delta p_B = -11$};
	\coordinate (B) at (25,249);
	\coordinate (A) at (30,249);
	\pic (fifth) at (B) [rotate=-0.467] {small pendulum=100};
	...
	\fill [on layer={axis background}] (-0.5,0) rectangle (49.5,-1.5)[opacity=.1];
	\node[right, align = left] at (-1,5) {$\Delta p_A = 12$\\$\Delta p_B = -12$};
	\coordinate (B) at (25,249);
	\coordinate (A) at (30,249);
	\pic (fifth) at (B) [rotate=-0.935] {small pendulum=100};
	\pic (sixth) at (A) [rotate=2.81] {pendulum=100};
...
\NC  v\sf \NC = \frac{p\sf}{m\sub{total}}
    ...
    = 4
\stopmathalignment\stopformula
A collision where the objects stick together is called \emph{totally inelastic}. Newton's example could have resulted in a totally inelastic collision, as shown in \in{figure}[fig:NewtonInelasticCollision]. The motion graph for this inelastic collision (\in{fig.}[fig:NewtonInelasticCollisionGraph]) shows the two balls moving together after the collision.
...
\stopformula
\startformula
	p\sub{i,$x$} + F_x\Delta t = p\sub{f,$x$} \qquad p\sub{i,$y$} + F_y\Delta t = p\sub{f,$y$}
\stopformula
...
\startformula\pagereference[eq:Fmg]
...
\qquad
\vec{p} = \components{180,0}\unit{g m/s}.
\stopformula
...
\section{Circular motion and centripetal force}\pagereference[sec:uniformcirc]
...
\startformula\pagereference[eq:centripetalforce]
	F = p\omega = \frac{pv}{R}
\stopformula
This is the extremely useful \keyterm{centripetal force formula}.
(Latin \quotation{petus} means \quotation{seeking}. The centripetal force is whatever force causes objects to seek the center.)
...
Recognizing Newton’s triumph, it would be easy for us to join the Cartesians in dismissing Leibniz. Before we do, it is worth understanding Leibniz’s purpose in proposing the conservation of \textit{vis viva}, with we will do in the next chapter.
