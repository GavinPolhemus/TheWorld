...
\placetable
    [margin]
    [T:firedballs]
    {Cannon balls fired directly toward each other have no total quantity of motion, according to Newton.  Descartes and Leibniz both say there is motion, but calculate different amounts (using \m{m=40\units{kg}} and \m{v=\pm50\units{m/s}}).}
...
Calculating rotational kinetic energy \m{K\sub{rot}} for more complicated shapes is, of course, more complicated. The object’s different parts move at different speed depending on their distance from the axis of rotation. 
