...
Both moving cannon balls have momentum, $mv$, but one ball’s momentum is positive while the other ball’s momentum is negative. The total momentum is \emph{zero} -- exactly the same as the total momentum of the two motionless cannon balls.
\placetable
    [margin]
    [T:firedballs]
...
The Dutch scientist Willem ’s Gravesande was famous in Leiden for his lecture demonstrations. He published  excellent textbooks on Newtonian physics, the first appearing in 1720. These are filled with detailed woodcuts of his elegant experiments, like the pendulum collision apparatus on \at{p.}[fig:GravesandeCollider]. ('s Gravesande's diagrams directly inspired many experiments which I perform with my own physics students.)
...
If a light, fast ball left the same size dent as a heavy, slow ball, then the two balls had produced the same effect.
...
In 1725, Daniel and Nicolaus, who were great friends as well as brothers, accepted a joint invitation from Peter the Great to join the new St.~Petersburg Academy in Russia.
...
\stopblockquote
Even as she refutes the Cartesian position, her mastery of Newtonian physics is on full display. In many  examples, she first uses Newtonian physics to predict what will happen. She then showes, based on this Newtonian analysis, that \visviva\ will also be conserved, but Descartes’ quantity of motion will not.
