...
This quantity of motion is bigger than the quantity of motion in the perpendicular orientation, just as Newton said. Clearly, the quantity of motion is not constant as the globes spin. However, the total momentum \m{\vec p = \vec p\sub{A} + \vec p\sub{B}} is constant, always to the right with a magnitude \m{p = 2}, as shown \in{figure}[fig:spinningmovingmomentum]. What about the \visviva?
