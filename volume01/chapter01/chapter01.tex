...
\stopexample
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\startexample[ex:PyConsonance]
Pythagoras and Philolaus invite you select a pipe and join their demonstration. They will play pipes with lengths 8 and 12. You want to select a remaining pipe (length 4, 6, 9 or 16) that is consonant with both of their pitches. According to the Pythagorean model, which pipe should you avoid?
\startsolution
...
These frequencies do not extend to the limits of human hearing, but they do cover a huge range\dash from the lowest A at $27\onehalf\units{Hz}$ up to the highest C at $4224\units{Hz}$. The middle A, used to tune an orchestra is in the middle, at $440\units{Hz}$.
...
If all the frequencies in \in{figure}[tab:Frequencies] were ten percent higher, nothing about the ratios would change.
