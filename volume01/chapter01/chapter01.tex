...
To find consonances, we are no longer interested in the lengths of pipes or strings, only their frequencies of oscillation.
...
The pitches A, C, and E also form a \keyterm{minor triad}. Minor triads also contain and major third, a minor third, and a perfect fifth, but minor triads are not as consonant as major triads. You can use our model of musical consonance to see why\dash just calculate the three-note ratio.
