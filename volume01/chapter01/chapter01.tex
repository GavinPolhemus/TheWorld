...
\startplacetable[location=margin, reference=fig:TinyPiano, title={Frequencies (Hz) of Zarlino's Just Intonation scale and Galelei's equal-tempered scale.}] % Caption
\startMPcode
  pickup pencircle scaled 0.8pt ;
