...
Ptolemy's scale offers something new\dash consonant thirds! To see why these are so exciting, let's check the ratios for some of Ptolemy's thirds. The third from low C to E has the ratio
\startformula
	\frac{60}{48}
		= \frac{5}{4}.
\stopformula
...
The scale's smallest intervals are individual steps, which are always dissonant. Ptolemy's scale has five larger steps and two smaller steps. The larger steps, with ratios of $9/8$ and $10/9$, are \keyterm{whole steps.}
...
Major triads contain a major third ($4{:}5$), a minor third ($5{:}6$), and a perfect fifth ($4{:}6=2{:}3$). All of this consonance gives the major third its heroic sound.
