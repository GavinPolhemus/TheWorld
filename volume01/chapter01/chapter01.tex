...
All of the consonant ratios from the Pythagorean model can be made from Ptolemy's octaves, perfect fifths, and perfect fourths, and with so many of these, musicians could blend consonant pitches starting from almost any note on the scale.
...
Galileo shares his observations with delight and wonder, and he uses his observations to better understand the various heavenly bodies.
...
He drew a sample, figure \in[fig:Orion], demonstrating the telescope’s power to reveal new details in the heavens.
