...
The magnitude of velocity $v$ is the absolute value $\abs{v}$, which is the \keyterm{speed}. Speed is always positive for a moving object, independent of the motion’s direction. The familiar formula for speed is \quotation{distance over time.} In our language, speed is \quotation{distance over duration.}
\startformula
