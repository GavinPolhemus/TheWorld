...
Music, arithmetic, astronomy, and geometry were the \quotation{four paths} to knowledge, known together as the {\em quadrivium.} Arithmetic and geometry describe abstract numbers and shapes. Music and astronomy  describe concrete, observable phenomena. The physical and abstract we closely joined – musical consonance with arithmetic ratios, and astronomical motions with geometric circles. The quadrivium was a beautiful system which brought order to Europeans’ understanding of the world until the end of the sixteenth century.
...
\startsolution
The interval is shown along with the Pythagorean steps in figure \in[fig:TinyPianoPtEx]. The interval encompasses D–E–F–G–A, so it is a fifth. To determine if it is a perfect fifth, we must add the four steps by multiplying their ratios. Using figure \in[fig:TinyPianoPtEx], the step from D to E is \m{9/8}, from E to F is \m{256/243}, etc.
\startformula
