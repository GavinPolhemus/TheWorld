...
\placefigure[margin][fig:TinyPiano]{Ptolemy's solution for the C major scale, along with several modern representations of the scale.} {\externalfigure[chapter01/TinyPiano]}
...
\placefigure[margin][fig:TinyPianoCompleteEq]{The equal tempered tuning is built from twelfth roots of two.} {\externalfigure[chapter01/TinyPianoCompleteEq][width=\rightmarginwidth]}
