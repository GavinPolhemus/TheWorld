...
Ancient musicians also discovered that {\em simple ratios produce consonant pitches.} For example, two pipes with lengths in the ratio of three-to-two or two-to-one (see figure \in[fig:Pythagoras]) will produce two pitches that sound good together – two consonant pitches. Wipes with less simple ratios, like nine-to-eight, will produce dissonant pitches. This mathematical model of music connects the purely mathematical idea of simple ratios to the physical phenomena of consonant sounds.
...
The Pythagoreans also sought an understanding of the cycles of nature – day and night, the seasons of the year, the Moon’s phases, and the motion of the visible planets. Simple ratios do not help: A year is about 365\onequarter\ days, a lunar month is about 29\onehalf\ days, so there are about 12\onethird\ lunar months in a year. %None of these are simple ratios.
...
\placefigure[margin][fig:TinyPianoPtEx]{The Ptolomaic scale with the interval sought in example \in[ex:TinyPianoPtEx].} {\externalfigure[chapter01/TinyPianoPtEx][width=\rightmarginwidth]}
\startsolution
...
\stopexample
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This horrible looking sequence of steps multiply to make a beautiful perfect fifth! (Prime factorization makes these calculations a breeze. You may want to refresh your powers of two, three, and five. Every number in the Ptolemaic system is a power of two, three, or five.)
