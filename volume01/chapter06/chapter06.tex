...
\startformula
	...
	\qquad
	dp_x = \left(-\frac{\partial H}{\partial p_x} + F_x \right) dt
\stopformula


\startformula\startalign[m=2,distance=5em]
\NC dx		\NC = \frac{p_x}{m}\,dt
\NC 	dp_x		\NC = \left(-\frac{\partial H}{\partial x} + F_x \right)	\NR
\NC dy		\NC = \frac{p_y}{m}\,dt
\NC 	dp_y		\NC = \left(-\frac{\partial H}{\partial y} + F_y \right) dt	\NR
\NC d\theta	\NC = \frac{p_\theta}{I}\,dt
\NC 	dp_\theta	\NC = \left(-\frac{\partial H}{\partial \theta} + F_\theta \right)	\NR
\stopalign\stopformula
