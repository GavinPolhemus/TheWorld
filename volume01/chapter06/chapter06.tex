...
As the the magnitude of $x$ increases, the magnitude of Hooke's force $F$ also increases, again in agreement with Lagrange.
...
Lagrange's equations of motion are a bit more tangled than our position and momentum update formulas, so we will not learn the details of his procedure. A general method for producing position and momentum update formulas was developed later by William Rowan Hamilton.
...
\marginTikZ{}{U3D}{The Sun produces a deep, wide potential well.
The gravitational potential $\Phi$ depends on  distance $r$ from the Sun.
The six visible plants are shown at their correct distances from the Sun.
A planet released from rest would accelerate toward lower potential energy, crashing into the Sun!} % vskip, name, caption

Following the logic of Lagrange's insight, we can see from \in{figure}[fig:U3D] that the direction of the gravitatinal force is in the direction of the Sun, toward lower potential energy. The force toward the central Sun does not produce any torque $\tau$ on the planets, so each plant's angular momentum $L$ is constant.
