...
\section{Conventional notation for angular momentum and torque}

I am switching to the standard notation for angular coordinates. Angular momentum is represented by $L$, (no longer $p_\theta$). Torque is represented by $\tau$, which is a greek letter tau (no longer $F_\theta$). In this notation, the formulas for angular momentum and conservation of angular momentum are
\startformula
  L = I\omega
  \qquad \text{and} \qquad
  L\si + \tau ∆t = L\sf.
...
\startformula
  K = \half I\omega^2
    = \frac{L^2}{2I}
\stopformula
These will be our notation and formulas for angular motion.
