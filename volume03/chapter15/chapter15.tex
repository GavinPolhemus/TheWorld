...
\placefigure[margin][fig:eabsorbsphoton]{{\bf Electron absorbing a photon} This diagram tells a story. Reading from left to right: \quotation{Once upon a time, there was an electron and a photon. The electron absorbed the photon, gaining some energy.}}
...
\NC \small$q=\pm1$ \NC \small$q=0$ \NC \small$q=0$ \NC \small$q=\pm1$ \NR
\NC \tfb$W$	     \NC \tfb$\gamma$ \NC \tfb$\pi^0$ \NC \tfb$\pi^\pm$ \NR
\NC \tfx W-boson  \NC \tfx photon  \NC \tfx pion \NC \tfx pion \NR
\NC $\txx 80.37\units{GeV}$ \NC \txx massless \NC $\txx 135.0\units{MeV}$ \NC $\txx 139.6\units{MeV}$ \NR
\LL[2]
\stoptabulate}
