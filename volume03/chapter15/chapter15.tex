...
\stopformula
This process requires a totally new interaction, different from either the electromagnetic or nuclear interactions. This new, weak interaction is due to the final particle in the Middle Model, the $W$ (for weak). The $W$ also has a large mass, which makes its interactions very short range. Two fermions can only exchange a $W$ when the fermions are extremely close together, which makes these reactions rare and its affect weak.
